...
class FeedbackStore(context: Context) {
    private val preferences = context.getSharedPreferences("devlab_feedback", Context.MODE_PRIVATE)
...
fun copyFeedbackBatch(context: Context, notes: List<FeedbackNote>, batchId: String) {
    ...
    clipboard.setPrimaryClip(ClipData.newPlainText("Dev Lab feedback", body))
}
